    ...
    <nav className="flex items-center justify-between px-6 md:px-16 lg:px-24 xl:px-32 py-4 border-b border-gray-200 bg-white relative transition-all">
      ...
      <div className="hidden sm:flex items-center gap-10">
        <button
          ...
          className="border border-gray-300 bg-primary/20 px-3 py-1 rounded-full text-xs cursor-pointer opacity-120"
        >
          Seller Dashboard
        </button>
        ...
        {!user ? (
          ...
          <div className="relative group">
            ...
            <ul className="hidden group-hover:block absolute top-10 right-0 bg-white shodow border border-gray-200 py-2.5 w-30 rounded-md text-sm z-40">
              <li
