...
const MainBanner = () => {
  return (
    <div className="relative">
      <img src={assets.main} alt="banner" className="w-full hidden md:block" />
      <img src={assets.main_sm} alt="banner" className="w-full md:hidden" />
      <div
      ...
      >
        <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-center md:text-left max-w-72 md:max-w-80 lg:max-w-105 leading-tight lg:leading-15'">
          Elegance in every thread, Designed for those who lead!
        </h1>
        <div className="flex items-center mt-6 font-medium">
          <Link
            to={"/products"}
            className="group flex items-center gap-2 px-7 md:px-9 py-3 bg-primary-dull
